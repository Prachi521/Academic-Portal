...
?>   
                                <tr>
                                    ...
                                    <td><button  onClick="showModal(<?php echo $row['sr_id'];?>)" name="subnot" class="btn btn-info btn-xs" value="<?php echo $row['sr_id'];?>">Notes</button></td>
                                    <td><button  onClick="showMod(<?php echo $row['sr_id'];?>)" name="subnot" class="btn btn-info btn-xs" value="<?php echo $row['sr_id'];?>">Syb</button></td>
                            	</tr>
<?php } } ?>
                        	</tbody>
                    	</table>
...
function showModal(id){
 window.location.href="show_notes.php?id="+id;
}
function showMod(id){
 window.location.href="show_syb.php?id="+id;
}
