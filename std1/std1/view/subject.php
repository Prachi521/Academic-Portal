                            ...
                            <div class="panel-heading">               
                             ...
                             <form role="form"  method="post" id="form2" enctype="multipart/form-data">
                                ...
                                <div class="panel-footer bg-blue-active">
                                    ...
                                    <input type="hidden" name="subject_id" value="<?php echo $_GET['name'];?>" id="subject_id"  />
                                    <input type="hidden" name="do" value="add_syllabus"  />
...
?>   
               ...
               <!--MSK-000115-td1--><td id="td2_<?php echo $row['id']; ?>"><a href="../uploadnotes/<?php echo $row['syllabus']; ?>"><?php echo $row['syllabus']; ?></a></td>
                                	<td>    
